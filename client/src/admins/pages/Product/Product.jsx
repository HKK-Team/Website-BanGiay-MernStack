...
export default function Product() {
    ...
    const [products, setProducts] = useState({
        nameProduct : data.nameProduct,idCategory_product : data.idCategory_product,color :'',size1 :data.size.size1,size2 :data.size.size2,size3:data.size.size3,size4:data.size.size4,size5:data.size.size5, price:data.price,image : data.image, _id : data._id
    });
    // set Edit Product
